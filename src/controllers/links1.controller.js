...
export const addLink = async (req, res) => {
  ...
  await req.setFlash("success", "Curso Guardado Correctamente");
...
export const deleteLink = async (req, res) => {
  ...
  await req.setFlash("success", `Curso: ${id} Eliminado Correctamente`);
...
export const editLink = async (req, res) => {
  ...
  await req.setFlash("success", "Curso Actualizado Correctamente");
  res.redirect("/links1");
};
